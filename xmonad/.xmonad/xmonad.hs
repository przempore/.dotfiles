...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_m), spawn $ "dmenu_run -i -nb '#191919' -nf '#fea63c' -sb '#fea63c' -sf '#191919' -fn 'NotoMonoRegular:bold:pixelsize=14'" )
  , ((modMask, xK_q), kill )
  , ((modMask, xK_s), spawn $ "pavucontrol" )
  ...
  , ((modMask, xK_comma), prevScreen) -- focus previous screen
  , ((modMask, xK_period), nextScreen) -- focus next screen
  ...
  , ((modMask .|. shiftMask , xK_c ), spawn $ "xmonad --recompile && xmonad --restart")
  ...
  , ((controlMask .|. mod1Mask , xK_b ), spawn $ "bluemail")
  , ((controlMask .|. mod1Mask , xK_c ), spawn $ "catfish")
  , ((controlMask .|. mod1Mask , xK_e ), spawn $ "arcolinux-tweak-tool")
  , ((controlMask .|. mod1Mask , xK_f ), spawn $ "firefox-developer-edition")
  , ((controlMask .|. mod1Mask , xK_g ), spawn $ "brave")
  , ((controlMask .|. mod1Mask , xK_i ), spawn $ "nitrogen")
  , ((controlMask .|. mod1Mask , xK_k ), spawn $ "keepassxc")
  -- , ((controlMask .|. mod1Mask , xK_l ), spawn $ "arcolinux-logout")
  , ((controlMask .|. mod1Mask , xK_m ), spawn $ "xfce4-settings-manager")
  , ((controlMask .|. mod1Mask , xK_o ), spawn $ "$HOME/.xmonad/scripts/picom-toggle.sh")
  , ((controlMask .|. mod1Mask , xK_p ), spawn $ "flameshot gui")
  ...
  , ((mod1Mask, xK_k), spawn $ "$HOME/.xmonad/scripts/refresh-keyboard.sh" )
  , ((mod1Mask, xK_c), spawn $ "$HOME/.xmonad/scripts/refresh-keyboard.sh set_control" )
  -- , ((mod1Mask, xK_t), spawn $ "variety -t" )
  , ((mod1Mask, xK_Up), spawn $ "amixer -q set Master 5%+" )
  , ((mod1Mask, xK_Down), spawn $ "amixer -q set Master 5%-" )
...
--  , ((0, xF86XK_AudioStop), spawn $ "mpc stop")
  ...
  -- Move current window to become master window.
  ...
  ++
  -- alt-{w,e,r}, Switch to physical/Xinerama screens 1, 2, or 3
  -- alt-shift-{w,e,r}, Move client to screen 1, 2, or 3
